...
class ArgParser(Tap):
    ...
    model_source: str # Whether the saved model is trained on harvard or kaggle

    def configure(self) -> None:
        self.add_argument("preprocessed_data")
        self.add_argument("model_path")
        self.add_argument("model_source")
...
test_loader = create_data_loaders(
    train_data=None, val_data=test_data, batch_size=128
)
